      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <form class="form-inline my-2 my-lg-0" action="auth/login" method="POST">
                {!! csrf_field() !!}
                <input class="form-control form-group mr-sm-2" type="text" placeholder="Login" name="username" value="{{ old('name') }}" id="username" aria-label="login">
...
<body>
 ...
 <div class="w3-container" id="menu">
  <div class="w3-content" style="max-width:700px">
    ...
    <div id="courses" class="w3-container menu w3-padding-48 w3-card">
      <h5>English</h5>
 ...
 <div class="title m-b-md">
    ...
    <div class="registration">
        ...
        <div class="form-group">
            ...
            <p><input type="text" name="username" value="{{ old('name') }}" id="username" class="form-control" placeholder="username"></p>
        </div>
        <div class="form-group">
